...
interface Passmodal {
    ...
    onClose: () => void;
    imgpassusage: string;
    titlepassMessageusage: string;
    passusageMessage1: string;
}

export default function ModalpassUsage({ isOpen, onClose, imgpassusage, titlepassMessageusage, passusageMessage1 }: Passmodal) {
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-60">
                <div className="bg-white  rounded-xl shadow-lg text-center lg:w-[670px] lg:h-[294px] relative w-[345px] h-[214px]">
                    ...
                    <h2 className="text-[3D3D3D] lg:text-[20px] lg:mb-[16px] font-semibold text-[18px] mb-[8px] lg:mx-[40px] mx-[24px]">
                        {titlepassMessageusage}
                    </h2>
                    <p className="text-[8B8B8B] lg:text-[16px] text-[14px] mx-[24px]">{passusageMessage1}</p>
